...
className={`${eduData ? "border-designColor rounded-lg ": "border-transparent" } resumeLi`}
...
className={`${expData ? "border-designColor rounded-lg ": "border-transparent" } resumeLi`}
...
className={`${achData ? "border-designColor rounded-lg ": "border-transparent" } resumeLi`}
...
>Achievements</li>
    ...
    <button
    className='w-full  px-10 h-10 text-designColor bg-black bg-opacity-25  hover:bg-opacity-50 rounded-lg flex 
    justify-center items-center shadow-shadowOne text-sm font-medium mb-[10px]' onClick={handleDownload}>Download CV</button>
    </div> */}
    </section>
